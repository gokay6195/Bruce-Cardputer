...
int RFID2::authenticate_mifare_classic(byte block) {
    uint8_t dict_keys[50][6] = {
        ...
        {0x01,0x23,0x45,0x67,0x89,0xAB}, {0x41,0x43,0x52,0x31,0x32,0x32}, {0xA0,0xA1,0xA2,0xA3,0xA4,0xA5},
        {0x13,0x57,0x9A,0xDF,0x26,0x48}, {0xFF,0x00,0xFF,0x00,0xFF,0x00}, {0x4D,0x3A,0x99,0xC3,0x51,0xDD},
        {0x00,0x00,0x00,0x00,0x00,0x00}, {0x14,0x07,0x88,0x14,0x07,0x88}, {0x20,0x21,0x22,0x23,0x24,0x25},
        {0x60,0x61,0x62,0x63,0x64,0x65}, {0x70,0x71,0x72,0x73,0x74,0x75}, {0x80,0x81,0x82,0x83,0x84,0x85},
        {0x90,0x91,0x92,0x93,0x94,0x95}, {0xA0,0xB1,0xC2,0xD3,0xE4,0xF5}, {0x54,0x43,0x52,0x11,0x22,0x33},
        {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}, {0x08,0x08,0x08,0x08,0x08,0x08}, {0x4B,0x45,0x59,0x47,0x45,0x4E},
        {0xAB,0xCD,0xEF,0x12,0x34,0x56}, {0x25,0x82,0xA1,0x99,0x77,0x00}
    };
    ...
    for (int i = 0; i < 50; i++) {
        delay(100); // Délai augmenté à 100ms pour une stabilité totale
